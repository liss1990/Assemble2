...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_8_dev_with_CallKit/RongCloud.bundle"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_8_dev_with_CallKit/en.lproj"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_8_dev_with_CallKit/zh-Hans.lproj"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_8_dev_with_CallKit/Emoji.plist"
  install_resource "RongCloudIMKitWithVoip/Rong_Cloud_iOS_IMKit_SDK_v2_6_8_dev_with_CallKit/RCConfig.plist"
